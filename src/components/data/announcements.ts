...
export const announcements: Announcement[] = [
	...
	},
	{
		...
		body: "The laser cutter in Makerspace 2 will be offline for scheduled maintenance this Friday from 10am to 2pm. Please plan your projects accordingly.\n\nIt will be back up and fully calibrated by Friday afternoon.",
		author: 'Marcus T.',
		timestamp: '1 day ago',
	},
	{
	...
	},
	{
		...
		body: "We've restocked PLA filament in black, white, grey, and translucent blue. The PETG supply is running low, so if you need it for a project, grab it soon.\n\nRemember to log your filament usage in the sheet by the printer.",
		author: 'Jane D.',
