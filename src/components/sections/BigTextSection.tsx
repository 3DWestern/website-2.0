...
export default function BigTextSection() {
	return (
		<section className="flex w-screen min-h-screen flex-col items-center text-center py-20 gap-y-20">
			<div className="mx-auto flex flex-col items-center justify-center gap-y-20">
				<h1 className={`text-5xl sm:text-7xl md:text-9xl ${koulen.className}`}>3D WESTERN</h1>
				<div className="font-bold text-black/50 p-4 w-4/6 mx-auto text-center sm:text-left flex flex-col items-start justify-center space-y-6 md:space-y-12 ">
