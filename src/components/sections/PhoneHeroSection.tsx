    ...
    <section className="h-[98vh] bg-white overflow-hidden px-4 md:px-8 lg:px-16 xl:px-8 pt-8 relative">
      ...
      <div className="relative w-full h-[98%] rounded-[1.25rem] lg:rounded-[1rem] overflow-hidden">
        ...
        <div className="relative w-full h-full bg-gradient-to-b from-purple-800 via-indigo-900 to-black">
          ...
          {/* Navigation card - top right - desktop only */}
          <div className={`hidden lg:block absolute -top-4 -right-20 xl:right-30 bg-white backdrop-blur-sm rounded-bl-2xl rounded-br-2xl px-8 py-4 transition-all duration-1000 ${isLoaded ? 'translate-y-0 opacity-100' : '-translate-y-full opacity-0'}`}>
      ...
      <div className={`absolute bottom-0 left-0 lg:left-8 xl:left-16 bg-white rounded-tr-2xl lg:rounded-tl-2xl pl-8 pr-5 py-3 lg:px-8 lg:py-4 transition-all duration-1000 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-full opacity-0'}`}>
        <p className="text-gray-900 font-semibold text-base lg:text-xl">
          ...
          <span className="block lg:inline text-gray-400 text-sm lg:text-base">
